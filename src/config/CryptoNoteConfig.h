...
For example:
UniBItXd --print-genesis-tx --genesis-block-reward-address TRTLv2Fyavy8CXG8BPEbNeCHFZ1fuDCYCZ3vW5H5LXN4K2M2MHUpTENip9bbavpHvvPwb4NDkBWrNgURAd5DB38FHXWZyoBh4wW
...
const uint32_t UPGRADE_HEIGHT_V5                             = 7; // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     LATEST_VERSION_URL[]                          = "http://latest.unibitx.org";
const std::string LICENSE_URL                                = "https://github.com/unibitx/unibitx/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb6, 0x0d, 0x4b, 0x6d, 0xbf, 0x42, 0x67, 0x51, 0x64, 0xf8, 0x93, 0xb4, 0xb9, 0xc4, 0x41, 0xe8  }
};

const char* const SEED_NODES[] = {
        "104.251.210.140", // Seed1
        "104.251.210.135", // Seed2
        "104.237.10.228",  // Seed3
};
} // CryptoNote
